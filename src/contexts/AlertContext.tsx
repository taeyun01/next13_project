...
export const AlertContextProvider = ({
  ...
  const $portal_root =
    typeof window === 'undefined' // window가 undefined이면 서버측에서 렌더링하고 있다는 의미
      ? null // 서버측에서 렌더링을 하고 있다면 null
      : document.getElementById('root-portal') // 클라이언트측에서 렌더링을 하고 있다면 document에 접근
